...
class CustomerDetailsResourceIT {
    ...
    void createCustomerDetails() throws Exception {
        ...
        restCustomerDetailsMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(customerDetailsDTO))
            )
        ...
        restCustomerDetailsMockMvc
            .perform(
                put(ENTITY_API_URL_ID, customerDetailsDTO.getId())
                    ...
                    .content(TestUtil.convertObjectToJsonBytes(customerDetailsDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamCustomerDetails() throws Exception {
        ...
        restCustomerDetailsMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(customerDetailsDTO))
            )
